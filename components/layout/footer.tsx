...
export default async function Footer() {
  ...
  const menu = [
    ...
    { title: "About", path: "https://reflowhq.com/" },
  ];
    ...
    <footer className="text-sm text-neutral-500 dark:text-neutral-400">
      <div className="mx-auto flex w-full max-w-screen-2xl flex-col gap-6 px-4 py-12 text-sm md:flex-row md:gap-12 md:px-6 dark:border-neutral-700">
        ...
        <div className="text-black md:ml-auto">
          <span className="block rounded p-2 dark:bg-white">
            <a
              href="https://github.com/Reflow-HQ/nextjs-commerce"
              aria-label="GitHub"
            >
              <svg
                width="24"
